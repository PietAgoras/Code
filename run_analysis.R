...
#' Step 1: Unzip the data in the wd, but leaving the original subdirectories
...
#' Step 1: Filtering out the neccesary columns. We do select meanFreq-variables as this is a different type of variable-measurement
raw<-raw[,c(1,563,
...
#' I will not rename any of the original feature-names as they contain information about how the variabele was measured. If I would rename them, this information would be lost. Subject and Activity already have descriptive labels
raw<-raw
